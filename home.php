				...
				<div class="row">
					...
					<div class="col-md-12 right-header">
						...
						<div class="right-header-detail">
							<form method="post">
								...
								<?php
									...
									if ($user_name === $username) {
										echo '<button name="logout" class="btn btn-danger">Logout</button>';
									}
							...
							?>
							<a class="float-right" href="account_settings.php"><i class="fa fa-2x text-white fa-cog" aria-hidden="true"></i></a>
</a>
						</div>
					</div>
				</div>
							...
							<ul>
								<?php
									...
									// if ($user_name == $sender_username) {
										...
										echo"
									   		<li class='d-block'>
									   		  	<div class='rightside-right-chat d-block'>
										...
										echo "
									   		<li>
									   		  	<div class='rightside-left-chat d-block'>
									   		  		<span>$sender_username <small> $msg_date</small> </span><br><br>
									   		  		<p>$msg_content</p>
									   		  	</div>
									   		</li>
