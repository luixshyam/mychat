			...
			<form action="" method="post" enctype="multipart/form-data">
				<table class="table table-bordered table-hover">
					...
					<tr>
						...
						<td>
							<input type="password" name=" current_pass" id="mypass" class="from-control" required placeholder="Current_Password" />
						</td>
					</tr>
					<tr>
						<td style="font-weight: bold;">New Password</td>
						<td>
							<input type="password" name=" u_pass1" id="mypass" class="from-control" required placeholder="New_Password" />
						</td>
					</tr>
					<tr>
						<td style="font-weight: bold;">Confirm Password</td>
						<td>
							<input type="password" name=" u_pass2" id="mypass" class="from-control" required placeholder="Confirm_Password" />
						</td>
					</tr>
					<tr align="center">
						<td colspan="6">
